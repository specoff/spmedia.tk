<?php 
/** Fenom template '_navbar.tpl' compiled at 2017-07-16 20:59:34 */
...
/* _navbar.tpl:6: {set $pages = $_controller->getMenu()} */
 $var["pages"]=$var["_controller"]->getMenu(); ?>
        <?php
/* _navbar.tpl:7: {foreach $pages as $name => $page} */
 $t4a75dfa5_1 = (isset($var["pages"]) ? $var["pages"] : null); if(is_array($t4a75dfa5_1) && count($t4a75dfa5_1) || ($t4a75dfa5_1 instanceof \Traversable)) {
